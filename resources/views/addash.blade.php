        ...
        <div class="layout-container layout-menu-fixed">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="" data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="menu-link">
                                ...
                                <div class="row">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="row w-75 justify-content-center mt-3">
                                            ...
                                            <div class="form-group d-flex col-md-5 m-1">
                                                <input type="search" name="search"
                                                    class="form-control form-control-sm" placeholder="Search..."
                                                    value="{{ $search }}">
                                            </div>

                                            <div class="form-group d-flex col-md-6 m-1">
                                                <label class="me-1">Problem </label>
                                                @if (isset($pt))
                                                    <select name="pt" class="form-select form-select-sm">
                                                        @foreach ($problem_types as $pt1)
                                                            <option value="{{ $pt1->problems }}"
                                    ...
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="row w-75 justify-content-center mt-2">
                                            <div class="form-group d-flex col-md-5 m-1">
                                            ...
                                            <div class="form-group d-flex col-md-4 m-1">
                                                <label class="me-1">Status</label>
                                                <select name="status" class="form-select form-select-sm">
                                                    <option value="0" {{ $status == 0 ? 'selected' : '' }}>Solved
                                                    </option>
                                            ...
                                            <div class="form-group d-flex col-md-2 justify-content-center m-1">
                                                <button class="btn btn-sm btn-outline-success"><i
                                                        class='bx bx-search-alt-2'></i></button>
                                                <a href="{{ url('/adlogin/addash/view') }}">
                                                    <button class="btn btn-sm btn-outline-danger ms-1"
                                                        type="button"><i class="bx bx-reset"></i></button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="dropdown d-flex justify-content-center">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('complain.edit', ['id' => $complains->complain_id]) }}">
                                                                <i class='bx bxs-edit'></i> edit complain</a>

                                                            <a class="dropdown-item"
                                                                href="{{ route('complain.delete', ['id' => $complains->complain_id]) }}"
                                                                onclick="return confirm('Are you sure you want to delete complain ?')">
                                                                <i class='bx bxs-trash'></i> delete complain</a>

                                                            @foreach ($blocked_customer as $bcust)
                                                                @if ($complains->customer_id == $bcust->customer_id)
                                                                    @if (empty($bcust->deleted_at))
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('customer.block', ['id' => $complains->customer_id]) }}"
                                                                            onclick="return confirm('Are you sure you want to block {{ $complains->name }} ?')">
                                                                            <i class='bx bx-block'></i> block user</a>
                                                                    @endif
                                                                @endif
                                                            @endforeach
