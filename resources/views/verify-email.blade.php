 ...
 <body>
     ...
     <div class="d-flex flex-row-fluid flex-column flex-column-fluid text-center p-10 py-lg-20 justify-content-center align-items-center"
         style="height: 100vh">
         ...
         <form action="{{ url('/reset-email') }}" method="post">
             ...
             @csrf
                 ...
                 <input type="hidden" name="old_email" class="form-control form-control-sm" value="{{$email}}" />
