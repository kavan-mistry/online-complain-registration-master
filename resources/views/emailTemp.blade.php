                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            ...
                            <h1 style="font-size: 48px; font-weight: 400; margin: 2;">Welcome!</h1> <img
                                src=" https://img.icons8.com/clouds/500/000000/handshake.png" width="125"
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;"><a href="{{ $data['url'] }}" target="_blank"
                                    style="color: #FFA73B;">{{ $data['url'] }}</a></p>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">Cheers,<br>OCR Team</p>
                        </td>
                    </tr>
                </table>
            </td>
