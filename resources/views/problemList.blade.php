        ...
        <div class="layout-container layout-menu-fixed">
            ...
            <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form action="{{ url('/adlogin/addash/problem_list') }}" method="post">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="staticBackdropLabel">Add Problem and It's Department
                                </h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i
                                        class="bx bx-x-circle"></i> Close</button>
                                <button type="submit" class="btn btn-primary">
                                    <i class="bx bx-check-circle"></i> Add</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-fluid navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center justify-content-between gap-3"
                        id="navbar-collapse">
                        ...
                        <div class="nav-item d-flex align-items-center">
                            <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                ...
                                <i class='bx bx-plus'></i> Add Problem Type
                            </button>
                        </div>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                                                    ...
                                                    <td>
                                                        <div class="dropdown d-flex justify-content-center">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="dropdown-item" href="{{ route('problem_list.delete', ['id' => $problems->id]) }}"
                                                                    onclick="return confirm(`Are you sure you want to delete {{ $problems->problems }} problem ? `)">
                        ...
                        @foreach ($problem_types as $problems)
                            <div class="modal fade" id="staticBackdrop2{{ $problems->id }}"
                                data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <form action="{{ url('/adlogin/addash/problem_list') . '/' . $problems->id }}"
                                            method="post">
                                            @csrf
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Problem and
                                                    It's Department
                                                </h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                    aria-label="Close"></button>
